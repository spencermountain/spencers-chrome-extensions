var date_extractor = (function() {
  ...
  var date_extractor = function(text) {
    ...
    do {
      ...
      if (results){
        ...
        all.push(obj)
        text=text.replace(obj.text, ' -- ')
      }
      counter++
    }while(results && text && counter<10000)
  }
  ...
  //foundarray[2] is the end date
    ...
    //console.log(exports.date_extractor('my wife left me on the 9th of april, 2005. '));
