...
var readability = {
    ...
    **/
    ...
    getArticleFooter: function () {
        ...
        "<div id='rdb-footer-print'><cite>" + document.title + "</cite><br />" + window.location.href + "</div>",
...
$("#readability-content").find("a").each(function() { $(this).replaceWith($(this).html()); })
$(".editsection").each(function() { $(this).remove()})
var text=$("#readability-content").html()

text=text.replace(/a/,'AA')
$("#readability-content").html(text)
$("#readability-content").css('font-size','20px;')
